	...
	return (
		<div className="text-primary_fg backdrop-filter backdrop-blur-sm bg-opacity-10  border border-primary_fg mx-auto min-w-[350px] max-w-[700px] text-center rounded shadow-lg shadow-secondary_bg px-2 py-4 mb-2 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
			<div className="flex justify-between items-center">
				<p className="text-secondary_fg text-xl font-medium">Cart</p>
				<IoClose
				...
				{rotiMenu ? (
					<div>
						...
						<div>
							...
							<div>
								<div className="flex justify-between bg-primary_bg py-2 px-4 text-left rounded border border-secondary_fg">
									<input
										type="radio"
										name="shippingtype"
										id="express"
								...
								<div className="flex justify-between bg-primary_bg py-2 px-4 text-left rounded border border-secondary_fg my-2">
									<input
										type="radio"
										name="shippingtype"
										id="next_day"
